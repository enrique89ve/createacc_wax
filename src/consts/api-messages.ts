...
export const API_MESSAGES = {
	ERRORS: {
		...
		TICKET_CANNOT_DELETE_USED: 'No se puede eliminar un ticket que ha sido usado',
		...
		CREDITS_PENDING_CHANGED: 'La cantidad de créditos pendientes ha cambiado o es insuficiente',
	...
	SUCCESS: {
		...
		BUILDER_CREATED_WITH_CREDITS: 'Builder creado exitosamente con 100 créditos pendientes',
