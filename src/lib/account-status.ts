...
export function toAccountStatusLabel(
...
export function parseBlockchainStatus(value: unknown): BlockchainStatus {
  ...
  if (value === BLOCKCHAIN_STATUS.BROADCASTED)
...
export function creationFlagsFromPersistedAccount(
  account: PersistedAccountCreation
) {
