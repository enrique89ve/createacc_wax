...
async function main(): Promise<void> {
	...
	line('Claimed accounts', claimedOk, String(diagnostics.creator.claimedAccounts))
	line('RC', rcOk, diagnostics.creator.rcPercent !== undefined ? `${diagnostics.creator.rcPercent}%` : 'n/a')
	console.log('')
